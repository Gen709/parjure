...
def get_json_pictures(request):
    photo_list = PhotosLibrary.objects.all()
    data_dict = {}
    data_dict["title"] = {"text": {
        "headline": "Parjure<br/> Élise Ayoub",
        "text": "<p>Le 25 septembre, Élise Ayoub a commis un parjure afin d'obtenir la garde exclusive de ses enfants.</p>"
    }
    }
    events = []
    for p in photo_list:
